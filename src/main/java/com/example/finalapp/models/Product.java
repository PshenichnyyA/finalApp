...
public class Product {
    ...
    //Дата и время создания нового товара
    private LocalDateTime dateTime;

    //Т.к. фотографий может быть много, то храним их в листе
    ...
    //Создаем промижуточную таблицу, в которой будет колоны product_id и person_id
    @ManyToMany
