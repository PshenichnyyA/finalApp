...
public class ProductController {
    ...
    //В рамках данного метода обращаемся к сервису
    //и вызываем метод, который вернет лист всех существющих продуктов
    //возвращаем шаблон, на котором будут отображены карточки товаров
    @GetMapping("")
